  ...
  render() {
    ...
    return (
      <>
        ...
        <nav className="small-device-container">
          <div className="small-device-top-container">
            <Link to="/" className="link-item">
              <img
                src="https://res.cloudinary.com/dqdx0yz2t/image/upload/v1711936595/Group_7399_1_elui8h.png"
                alt="website logo"
                className="website-logo-small-device"
              />
            </Link>
            <div className="small-device-profile-container">
              {isSearch ? (
                <div className="search-container">
                  <input
                    type="search"
